    ...
    <div className="px-5 py-5 h-full flex flex-col">
      ...
      >
        ...
        <button
          ...
          className="flex-1 py-2.5 rounded-full text-[13px] font-bold transition-all"
          style={{
            background: mode === 'break' ? 'linear-gradient(135deg, var(--accent-sky), #0EA5E9)' : 'transparent',
          ...
          <svg width={size} height={size} className="absolute inset-0 -rotate-90 glow-ring">
            <defs>
              <linearGradient id="pomoGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor={mode === 'work' ? '#6366F1' : '#38BDF8'} />
                <stop offset="100%" stopColor={mode === 'work' ? '#8B5CF6' : '#0EA5E9'} />
              </linearGradient>
            </defs>
            {/* 背景轨道 */}
            <circle
        ...
        <button
          ...
          style={{
            background: mode === 'work'
              ...
              : 'linear-gradient(135deg, var(--accent-sky), #0EA5E9)',
