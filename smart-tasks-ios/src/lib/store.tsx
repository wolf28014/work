...
import { generateNextRecurrence, todayStr, localDateStr } from './task-utils';
...
export function TaskProvider({ children }: { children: ReactNode }) {
  ...
  async function seedDemoData() {
    const demoTasks: Task[] = [
      ...
      { id: genId(), title: '完成产品需求文档', description: '梳理 V2.0 版本核心功能模块', dueDate: localDateStr(new Date(Date.now() + 86400000)), startDate: todayStr(), priority: 'high', status: 'in_progress', recurrence: null, tags: ['工作', '产品'], subtasks: [{ id: genId(), title: '竞品分析', done: true, order: 0 }, { id: genId(), title: '功能列表', done: false, order: 1 }, { id: genId(), title: '原型评审', done: false, order: 2 }], dependsOn: [], pomodoros: 3, noteMarkdown: null, createdAt: Date.now() - 86400000, updatedAt: Date.now(), completedAt: null, deletedAt: null },
      { id: genId(), title: '每日阅读 30 分钟', description: '', dueDate: todayStr(), startDate: null, priority: 'low', status: 'todo', recurrence: 'daily', tags: ['学习'], subtasks: [], dependsOn: [], pomodoros: 0, noteMarkdown: null, createdAt: Date.now() - 86400000, updatedAt: Date.now(), completedAt: null, deletedAt: null },
      { id: genId(), title: '健身房训练', description: '腿日：深蹲 + 硬拉', dueDate: todayStr(), startDate: null, priority: 'medium', status: 'todo', recurrence: 'weekly', tags: ['健康'], subtasks: [], dependsOn: [], pomodoros: 1, noteMarkdown: null, createdAt: Date.now() - 2 * 86400000, updatedAt: Date.now(), completedAt: null, deletedAt: null },
      { id: genId(), title: '回复客户邮件', description: '', dueDate: todayStr(), startDate: null, priority: 'high', status: 'done', recurrence: null, tags: ['工作'], subtasks: [], dependsOn: [], pomodoros: 1, noteMarkdown: null, createdAt: Date.now() - 86400000, updatedAt: Date.now(), completedAt: Date.now(), deletedAt: null },
      { id: genId(), title: '准备周会汇报', description: '本周进度 + 下周计划', dueDate: localDateStr(new Date(Date.now() + 2 * 86400000)), startDate: null, priority: 'high', status: 'todo', recurrence: 'weekly', tags: ['工作'], subtasks: [], dependsOn: [], pomodoros: 0, noteMarkdown: null, createdAt: Date.now() - 86400000, updatedAt: Date.now(), completedAt: null, deletedAt: null },
      ...
      { id: genId(), title: '整理本月开支', description: '', dueDate: localDateStr(new Date(Date.now() + 5 * 86400000)), startDate: null, priority: 'low', status: 'todo', recurrence: 'monthly', tags: ['生活'], subtasks: [], dependsOn: [], pomodoros: 0, noteMarkdown: null, createdAt: Date.now() - 86400000, updatedAt: Date.now(), completedAt: null, deletedAt: null },
    ];
    const demoTags: Tag[] = [
